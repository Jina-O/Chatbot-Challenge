...
# 슬랙 토큰으로 객체 생성
token = 'xoxb-503818135714-506719126544-sRpKVA941s5mX4FM5jqeo3Qd'
slack = Slacker(token)

app = Flask(__name__)
slack_token = 'xoxb-503818135714-506719126544-sRpKVA941s5mX4FM5jqeo3Qd'
...
def choose_clothes(temperature):
    ...
    return2hundreds()
    slack.files.upload('middle1.png', channels="#team6_test")

    return "오늘은 이렇게 입는 걸 추천드려요!"
